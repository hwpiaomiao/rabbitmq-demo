...
public class TopicModelConfig {
	public static final String TEST_EXCHANGE = "topic_amqp_exchange";
	public static final String TEST_QUEUE_1 = "topic_amqp_queue_1";
	public static final String TEST_QUEUE_2 = "topic_amqp_queue_2";
